...
// @downloadURL  https://github.com/Apkawa/userscripts/raw/master/dist/civitai.com/copy-download-link-as-aria2c.user.js
// @updateURL    https://github.com/Apkawa/userscripts/raw/master/dist/civitai.com/copy-download-link-as-aria2c.user.js
// @license      MIT
// ==/UserScript==
(() => {
    "use strict";
    ...
    function addButtonToLink(linkElement) {
        ...
        if (parent && parent.tagName !== "BUTTON") if (linkElement.nextSibling) parent.insertBefore(button, linkElement.nextSibling); else parent.appendChild(button); else linkElement.insertAdjacentElement("afterend", button);
    }
    ...
    function observeDOMChanges() {
        const observer = new MutationObserver(mutations => {
            ...
            for (const mutation of mutations) if (mutation.type === "childList" && mutation.addedNodes.length > 0) {
                shouldProcess = true;
                break;
            }
            if (shouldProcess) processAllLinks();
        });
