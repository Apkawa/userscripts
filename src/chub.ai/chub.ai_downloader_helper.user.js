...
(function() {
    ...
    function processImages() {
        ...
        imgs.forEach(img => {
            ...
            if (src.startsWith('https://avatars.charhub.io/avatars/Anonymous/example-character/') // Заглушка
            ...
            let username, name, downloadUrl, filename, isLorebook = false;
            ...
            if (isLorebook) {
                ...
                btn.onclick = async (e) => {
                    ...
                    try {
                        ...
                        if (!idData.node || !idData.node.id) throw new Error('Lorebook ID not found in API response');
